<?php
    ...
    <section id="references" class="section scrollspy">
        ...
        <section>
            ...
            <p>
                Der Ort, an dem das Script zu Hause ist: <a href="https://greasyfork.org/de/scripts/4466-chip-download-wechsel" rel="noopener" target="_blank" title="GreasyFork">https://greasyfork.org/de/scripts/4466-chip-download-wechsel</a>
            </p>
        </section>
        <section>
            <h3>
