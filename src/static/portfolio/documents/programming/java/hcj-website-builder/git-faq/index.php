<?php
    ...
    <section id="chatexample" class="section scrollspy">
        ...
        <div>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Ich verstehe nicht ganz wie man Eclipse auf Github einstellt.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Wenn ich mich nicht irre, ist eGit (was man doch braucht) schon dabei oder?<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Genau.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Ich kenne mich mit Eclipse noch nicht so aus, ich habe bisher nur ein "Hello World"-Projekt erstellt.<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Okay, also noch eins? :D<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Wie heißt das?<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Moment...<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Obwohl ich das dann doch erstmal lieber im Browser mache.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Hauptsache ich kann da jetzt mal noch was übersetzen :D<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Kennst du Dich schon mit git aus?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Im Webbrowser auf Github kann man sich keine Nachrichten direkt schicken, oder?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Nicht wirklich ;)<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Okay^^<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Gut :)<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Unser Repository habe ich glaube ich schon reinbekommen in Eclipse.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Kann ich das irgendwie updaten?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Dass die lokalen Dateien aktualisiert werden.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Über fetch vielleicht?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Ich glaube, das hab ich hinbekommen.<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Genau!<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>:D<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Jetzt habe ich die Dateien in der working directory. Wie kann ich meine Bearbeitungen push-requesten?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Aber nicht, dass der dann gleich hinzugefügt wird. Der soll ja noch reviewt werden, oder wie geht das?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Okay.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Soll ich jetzt eigentlich einen neuen Branch erstellen? Ich will ja nur andere bearbeiten oder verstehe ich das mit den Branches falsch?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Ist ein branch nicht eine Kopie des masters?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Also muss ich unter HCJ-Website-Builder->Branches->Local mit Rechtsklick einen neuen Branch erstellen?<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Genau. master -> Create branch<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>also master dc415c1 Merge Pul... usw?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Also auf "local" rechtsklick -> switch to new branch oder wo?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Finde ich nicht :D<br>
            <div class="center-align"><em>*** Jonas hat einen Screenshot gesendet ***</em></div><br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Da steht master und irgendwas anderes, ist das egal?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Okay das meinte ich, nur war ich unsicher, weil da eben nicht master sondern master xyz steht.<br>
            ...
            <div class="center-align"><em>*** Jonas hat einen Screenshot gesendet ***</em></div><br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Wenn du noch einen haben willst^^ :D<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Welche checkboxen soll ich denn aktivieren?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>configure upstream for p&p und checkout new branch. Was bewirken die denn?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Okay, gut :)<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Aber checkouten kann ich ruhig oder mache ich da auch was kaputt? :D<br>
            ...
            <div class="center-align"><em>*** Jonas hat einen Screenshot gesendet ***</em></div><br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>So lassen?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Hab.<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Sehr gut, hat funktioniert!<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>*freu*<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Rechtsklick auf den neuen Eintrag in remote tracking und dann checkout as new local branch?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Okay.<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Ja.<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Aber der existed schon ... irgendwie logisch :D<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Ja.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Wie bearbeite ich den denn jetzt? :D<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Einfach die working directory bearbeiten und dann pushen?<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Okay, hab ich. Sieht gut aus :) Hab mein "Hello World"-Projekt jetzt gelöscht. Sollte aber nur aus dem workspace gelöscht worden sein und sich noch auf der Festplatte befinden oder?<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Jaaaaaaa.... 2 Tage? :D<br>
            <div class="chip"><img src="../layout/images/grhcj.png" alt="GRHCJ">Lukas</div>Eigentlich schon.<br>
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>;)<br>
            ...
            <div class="chip"><img src="'.$_SERVER['SERVER_ROOT_URL'].'/layout/images/logo.png" alt="Logo">Jonas</div>Merkt man an deinen Kenntnissen :D<br>
