<?php
    ...
    <section id="description" class="section scrollspy">
        ...
        <p>
            ...
            Man kann das Script einerseits "Offline", also manuell installieren oder von <a href="https://greasyfork.org/de/" target="_blank" title="GreasyFork">Greasy Fork</a> laden lassen.
