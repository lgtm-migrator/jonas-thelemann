    ...
    <section id="projects" class="section scrollspy">
        ...
        <section id="databases" class="section scrollspy">
            ...
            <p>
                ...
                Die <a href="https://github.com/Dargmuesli/asyl-db" target="_blank" title="AsylDB">AsylDB</a> dient zur individuellen Fähigkeitsförderung der Asylbewerber.
                Die <a href="https://github.com/Dargmuesli/ehra-db" target="_blank" title="EhraDB">EhraDB</a> ist eine Datenbank zur Ehrenamtsverwaltung in der Organisationseinheit Flüchtlingshilfe des Landkreises Kassel.
            </p>
        </section>
        <section id="javascript" class="section scrollspy">
            ...
            <p>
                ...
                Weil ich mich weiter mit Java beschäftigen wollte - und weil ich es immer schon einmal machen wollte - habe ich zwei kleine <a href="https://github.com/Dargmuesli?tab=repositories&q=spigot+server+plugin&type=source&language=java" target="_blank" title="Repositories">Spigot Server Plugins</a> geschrieben.
                Kurz darauf erhielt ich Rückmeldung von einem Bekannten, der bei Spotify arbeitet: ich war endlich Maintainer vom <a href="https://github.com/thelinmichael/spotify-web-api-java" target="_blank" title="thelinmichael/spotify-web-api-java">Spotify Web API Wrapper für Java</a>!
            </p>
        </section>
        <section id="javascript" class="section scrollspy">
            <h3>
        ...
        <section id="powershell" class="section scrollspy">
            ...
            <p>
                ...
                Hier bat sich <a href="https://github.com/PowerShell/PowerShell" target="_blank" title="PowerShell">PowerShell</a> an, da es nativ auf Windows und mit PowerShell 6 auch auf Linux und MacOS funktioniert.
                <br>
                Zuerst entstand mein Skript zum Managen von Dockerprojekten <a href="https://github.com/Dargmuesli/ps-docker-management" target="_bank" title="PS-Docker-Management">PS-Docker-Management</a>.
                Als abzusehen war, dass viele Funktionen auch in anderen Projekten benötigt werden könnten, lagerte ich diese in die mittlerweile ziemlich umfangreiche PowerShell-Bibliothek <a href="https://github.com/Dargmuesli/PowerShell-Lib" target="_blank" title="PowerShell-Lib">PowerShell-Lib</a> aus.
                <br>
                Im ersten Semester meines Informatikstudiums waren Hausaufgaben in einem Modul als .jar-Datei abzugeben, wofür ein das Tool <a href="https://github.com/Dargmuesli/plm-jar-builder" target="_bank" title="PLM-Jar-Builder">PLM-Jar-Builder</a> schrieb.
        ...
        <section id="python" class="section scrollspy">
            ...
            <p>
                ...
                So entstand Ende 2016 der WhatsApp-Bot Tom, der unter dem Projektnamen <a href="https://github.com/Dargmuesli/bottom-news" target="_blank" title="BotTom News">BotTom News</a> entwickelt wurde.
        ...
        <section id="websites" class="section scrollspy">
            ...
            <section id="jonas-thelemann.de" class="section scrollspy">
                ...
                <p>
                    ...
                    Momentan enthält sie an vielen Stellen hauptsächlich <strong>Fülltext und unfunktionale Seiten</strong>, da es nach Fertigstellung von Design und genereller Funktionalität fast ein Jahr gedauert hat, diese Website als <a href="https://github.com/dargmuesli/jonas-thelemann.de" target="_blank" title="Dargmuesli/jonas-thelemann.de">Projekt auf GitHub</a> zu veröffentlichen.
            ...
            <section id="randomwinpicker.de" class="section scrollspy">
                ...
                <p>
                    Um die Website <a target="_blank" href="https://jonas-thelemann.de/?" title="randomwinpicker.de">randomwinpicker.de</a> für den YouTuber <a href="https://www.youtube.com/user/dragonflygames" target="_blank" title="Megaquest">Megaquest</a> programmieren zu können, musste die Entwicklung meiner eigenen Website kurz nachdem sie begonnen hatte pausieren.
                    ...
                    <br>
                    Aus heutiger Sicht ist <a href="https://github.com/dargmuesli/randomwinpicker.de" target="_blank" title="Dargmuesli/randomwinpicker.de">der Quellcode der Website</a> nicht schön zu lesen.
        ...
        <section id="visual-basic" class="section scrollspy">
            ...
            <p>
                ...
                Nach gründlicher Bug-Suche und ausführlichem Testen habe ich diese Version von <a href="https://github.com/Dargmuesli/batchrename" target="_blank" title="Github">BatchRename</a> auf GitHub veröffentlicht.
                <br>
                Mit VB habe ich auch Mitte 2016 ein weiteres Tool, <a href="https://github.com/Dargmuesli/cover-extract" target="_blank" title="CoverExtract">CoverExtract</a>, geschrieben, das ein Frame zu einem angegebenen Zeitpunkt in mehreren Videos als Bild abspeichert.
