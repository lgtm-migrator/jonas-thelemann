...
FROM node:14.16.0-buster-slim@sha256:ffc15488e56d99dbc9b90d496aaf47901c6a940c077bc542f675ae351e769a12 AS build
...
FROM php:7.4.16-fpm-buster@sha256:74d0c581b97d7d882fdf18ea13a3ddd328408fc76e38b8a93d27dcdd0bf91ad1 AS development
...
# Base image
FROM php:7.4-fpm-alpine@sha256:c03104dd73e55f72e35456a2f93cf054ad35dcd31a11d87d4e43098aaa397dab AS production
